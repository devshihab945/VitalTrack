...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_change_avatar).setOnClickListener(v -> photoPickerLauncher.launch(new PickVisualMediaRequest.Builder().setMediaType(ActivityResultContracts.PickVisualMedia.ImageOnly.INSTANCE).build()));
        ...
        btnPrivacyPolicy.setOnClickListener(v -> {
            String url = "https://xerotrust.shop/VitalTrack/privacy_policy.html";
    ...
    private void saveProfile() {
        ...
        if (!isUnitCm) {
            ...
            if (fStr.isEmpty()) {
                etHeightFeet.setError("ফুট লিখুন");
                return;
            }
        }
    ...
    private String getInitials(String name) {
        ...
        return (parts.length > 0 && !parts[0].isEmpty()) ? String.valueOf(parts[0].charAt(0)).toUpperCase() : "U";
    }
}
